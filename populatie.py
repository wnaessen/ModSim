...
def populatie_model(tijdstappen, v_0, m1_0, m2_0, r_v, K_v, K_m, d_nv, d_n1, d_n2, r_1, r_2, alpha_1, alpha_2, m2_in, returnDataFrame=True):
    """
...
def abs_sensitiviteit(tijd, model, parameternaam, pert, args):
    ...
    populatie_hoog = model(tijd,args['v_0'],args['m1_0'],args['m2_0'],args['r_v'],args['K_v'],args['K_m'],args['d_nv'],args['d_n1'],args['d_n2'],args['r_1'],args['r_2'],args['alpha_1'],args['alpha_2'], args['m2_in'])
    args[parameternaam]= parameterwaarde - parameterwaarde*perturbatie
    populatie_laag = model(tijd,args['v_0'],args['m1_0'],args['m2_0'],args['r_v'],args['K_v'],args['K_m'],args['d_nv'],args['d_n1'],args['d_n2'],args['r_1'],args['r_2'],args['alpha_1'],args['alpha_2'], args['m2_in'])
...
def rel_sensitiviteit_var(tijd, model, parameternaam, pert, args):
    ...
    populatie_gewoon = model(tijd,args['v_0'],args['m1_0'],args['m2_0'],args['r_v'],args['K_v'],args['K_m'],args['d_nv'],args['d_n1'],args['d_n2'],args['r_1'],args['r_2'],args['alpha_1'],args['alpha_2'], args['m2_in'])
    args[parameternaam]= parameterwaarde + parameterwaarde*perturbatie
    populatie_hoog = model(tijd,args['v_0'],args['m1_0'],args['m2_0'],args['r_v'],args['K_v'],args['K_m'],args['d_nv'],args['d_n1'],args['d_n2'],args['r_1'],args['r_2'],args['alpha_1'],args['alpha_2'], args['m2_in'])
    args[parameternaam]= parameterwaarde - parameterwaarde*perturbatie
    populatie_laag = model(tijd,args['v_0'],args['m1_0'],args['m2_0'],args['r_v'],args['K_v'],args['K_m'],args['d_nv'],args['d_n1'],args['d_n2'],args['r_1'],args['r_2'],args['alpha_1'],args['alpha_2'], args['m2_in'])
